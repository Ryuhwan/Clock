...
public class SnowPanel extends JPanel implements Runnable {
	...
	ImageIcon ima = new ImageIcon("images/snow.png");
	...
	protected void paintComponent(Graphics g) {
		...
		for (Iterator iterator = snowList.iterator(); iterator.hasNext();) {
			...
			g.drawImage(image, snowObject.getPoint().x, snowObject.getPoint().y, snowObject.snow_size, snowObject.snow_size, this);
		}
	}
}
